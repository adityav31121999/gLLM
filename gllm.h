...
// #include <script.hpp>           // script for running/training LLM
...
if(USE_CUDA)
    ...
    set(CMAKE_CUDA_ARCHITECTURES 86)  # Ampere (RTX 30 series)
...
# Add a global compile definitions
if(USE_CUDA)
