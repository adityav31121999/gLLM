...
#include "gllm.h"
    ...
    std::vector<std::string> kernelNames = {
        ...
        "kernelUpdateWeights_EH_EV_L1",
        "kernelUpdateWeights_EV_V_L1",
        "kernelUpdateWeights_1stHead_H_L1",
        "kernelUpdateWeights_1stHead_V_L1",
        "kernelUpdateWeights_1stHead_HV_L1",
        "kernelUpdateWeights_EH_EV_L2",
        "kernelUpdateWeights_EV_V_L2",
        "kernelUpdateWeights_1stHead_H_L2",
        "kernelUpdateWeights_1stHead_V_L2",
        "kernelUpdateWeights_1stHead_HV_L2",
