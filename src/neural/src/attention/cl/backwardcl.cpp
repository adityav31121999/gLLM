 ...
 */
void attention::clbackward(std::vector<float>& expected, int& in, int& layers, int& headnumber, float& learning)
{
    // --- Setup ---
 ...
 */
void attention::clbackward(std::vector<std::vector<float>>& expectedV, int& layers, int& blocknumber, float& learning)
{
    // --- Setup ---
    const int embedding_dim = EMBEDDING;
    const int mat_heights = MATHEIGHTS;
