    ...
    try {
        ...
        for (int head_idx = num_heads_to_process - 1; head_idx >= 0; --head_idx) {
            ...
            for (int l = 0; l < num_weight_matrices_mlp; ++l) { 
                ...
                CL_CHECK(k_update_weights_h.setArg(3, learning_rate)); // learning_rate
            ...
            for (int l = 0; l < num_weight_matrices_mlp; ++l) { 
                ...
                CL_CHECK(k_update_weights_v.setArg(3, learning_rate)); // learning_rate
                CL_CHECK(k_update_weights_h.setArg(4, lambda_l2)); // lambda_l2
            ...
            cl::Kernel k_update_1st_h_2 = clcontext.kernels.at("kernelUpdateWeights_1stHead_H_L2");
            ...
            CL_CHECK(k_update_1st_h_2.setArg(12, lambda_l2)); CL_CHECK(cl_err);
            CL_CHECK(k_update_1st_h_2.setArg(13, mat_heights)); CL_CHECK(cl_err);
            CL_CHECK(k_update_1st_h_2.setArg(14, embedding_dim)); CL_CHECK(cl_err);
