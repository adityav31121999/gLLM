 ...
 * @param modelDir_param Base directory path for model files (e.g., where block files will be stored).
 */
transformer::transformer(int m_param, int x_param, int y_param, int n_param, int d_param, int h_param, 
    int l_param, long long int vocab_param, bool attentionType_param, bool& inTraining_param, 
 ...
 */
transformer::transformer(int m_param, int x_param, int y_param, int n_param, int d_param, int h_param, 
    int l_param, long long int vocab_param, float learning_rate_param, bool attentionType_param,
...
transformer::transformer(OpenCLContext& context_param, int m_param, int x_param, int y_param, 
    int n_param, int d_param, int h_param, int l_param, long long int vocab_param, bool attentionType_param,
    bool& inTraining_param, const std::string& modelDir_param) :
    ...
    embeddings(vocab_param, d_param), tokenEmbed(m_param * n_param, d_param)
{
    ...
    // Note: this->d, this->n etc. are now correctly initialized from d_param, n_param etc.
    // and can be used for params calculation.
    if(this->inTraining) {
