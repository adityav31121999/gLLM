...
void create(std::string &locationOfALLbins)
{
    ...
    unsigned long long mat_size = static_cast<unsigned long long>(NUMBER_OF_BLOCKS * NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * CONTEXT_WIN);
    ...
    unsigned long long totalParams = (4*NUMBER_OF_BLOCKS * NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * CONTEXT_WIN
    ...
    unsigned long long trainableParams = (4*NUMBER_OF_BLOCKS * NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * CONTEXT_WIN
                                   + 2*NUMBER_OF_BLOCKS * NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * EMBEDDING * LAYERS_MLP);
    unsigned long long inferenceParams = (2*NUMBER_OF_BLOCKS * NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * EMBEDDING * LAYERS_MLP
                                   + 3*NUMBER_OF_BLOCKS * NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * EMBEDDING);
    unsigned long long block1stParams = (4*NUMBER_OF_HEADS * NUMBER_OF_PA * EMBEDDING * CONTEXT_WIN
